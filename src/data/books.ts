...
export const books: BookSummary[] = [
  {
    ...
    reflectionPrompt: "What tiny action would prove today that I am becoming more disciplined?"
  },
  {
    id: "deep-work",
    title: "Deep Work",
    ...
    reflectionPrompt: "What is one task that deserves my best attention instead of my leftover attention?"
  },
  {
    id: "mindset",
    title: "Mindset",
    ...
    reflectionPrompt: "Where am I treating a learning curve like a personal flaw?"
  },
  {
    ...
    reference: "Rosenberg, Marshall B. Nonviolent Communication. PuddleDancer Press, 1999.",
    summary: [
    ...
    reflectionPrompt: "What do I need to say clearly without blaming the other person?"
  },
  {
    ...
    reference: "Frankl, Viktor E. Man's Search for Meaning. Beacon Press edition, 2006.",
    summary: [
    ...
    reflectionPrompt: "What is life asking of me today, and how do I want to answer?"
  },
  {
    id: "the-power-of-now",
    ...
    reflectionPrompt: "Where am I living in my head instead of meeting this moment?"
  },
  {
    id: "essentialism",
    title: "Essentialism",
    ...
    reflectionPrompt: "What am I saying yes to that quietly steals from what matters most?"
  },
  {
    id: "the-7-habits",
    ...
    bestFor: "Principle-centered growth across work, relationships, and character.",
    reference: "Covey, Stephen R. The 7 Habits of Highly Effective People. Free Press, 1989.",
    summary: [
    ...
    reflectionPrompt: "What choice today would align with the person I want to become?"
  }
];

export function recommendedBooks(goals: GrowthGoal[]) {
  if (!goals.length) return books;
  return [...books].sort((first, second) => scoreBook(second, goals) - scoreBook(first, goals));
}
