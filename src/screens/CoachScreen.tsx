	...
	const send = async () => {
		...
		try {
			...
			if (!result.text.trim()) {
				Alert.alert(
					"Coach",
					"The AI replied, but the message was empty. Try again with a shorter question.",
				);
				return;
			}
	...
	return (
		<View>
			...
			<Card style={styles.ask}>
				...
				/>
				<Button
					label={loading ? "Thinking..." : "Ask Coach"}
					onPress={send}
			...
			<View style={styles.messages}>
				...
				{!state.coach.length ? (
					<Text style={styles.empty}>
						When you ask something, your coaching thread will appear here.
					</Text>
				) : null}
			</View>
		</View>
